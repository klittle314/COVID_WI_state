...
`r paste0('Date of file is ', as.character(max(df1$Date_Time),na.rm=TRUE))`
...
ptest <- ggplot(data=df_slopes,aes(x=Date_end,y=slope))+
        ...
        labs(title = 'Slope of Pct Positive Tests: 14 day windows',
             subtitle = "The slope represents the slope of the linear fit to the 14 days \n ending at the date on the x axis",
             caption = '95 percent confidence interval limits marked by *')+
