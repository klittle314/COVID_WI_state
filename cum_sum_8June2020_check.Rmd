...
I have not figured out how to calculate ARL for the DHS proposed ratio chart (the analysis depends on whether I have characterized the DHS method correctly, of course).
...
```{r reg_cusum_setup1, echo = TRUE}
 ...
 print(paste0("k value given new count_rate ",new_count_rate,": ",k1))
  
  #Using Lucas Table 2, for k = 3 and null mean ratio 0.8 and alternative mean ratio 1.2, 
  #h = 5 provides a cusum chart with ARL in null case of 52 weeks and ARL in alternative of 7 weeks
  ...
  #Need to use code from Cusum script.
